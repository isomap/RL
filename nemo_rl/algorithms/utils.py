...
def compute_spec_decode_metrics(
    ...
    Example:
        >>> start = aggregate_spec_decode_counters(policy_generation.get_metrics())
        >>> # ... run generation ...
        >>> end = aggregate_spec_decode_counters(policy_generation.get_metrics())
        >>> metrics = compute_spec_decode_metrics(start, end)
